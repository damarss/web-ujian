    ...
    <body>
        ...
        <script>
            ...
            fetch(url)
                ...
                .then((data) => {
                    currentSoal = data;
                    idUjian = currentSoal[0].id_ujian.id;
                    for (i in data) {
                    ...
                    soal.innerHTML += "<div class='action-wrapper'>" +
                        "<a class='btn' href='/ujian'>Kembali</a><a class='btn cons' href='/tolak-pengajuan/" + idUjian + "'>Tolak</a><a class='btn' href='/approve-pengajuan/" + idUjian + "'>Approve</a>" +
                        "</div>"
                })
